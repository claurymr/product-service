...
public class GetProductsByIdQueryHandler : IRequestHandler<GetProductsByIdQuery, IEnumerable<ProductQueryResponse>>
{
    // Declare repository private field
    // Declare httpclient private field
    // Call main ctor and initialize repository and httpclient
    public Task<IEnumerable<ProductQueryResponse>> Handle(GetProductsByIdQuery request, CancellationToken cancellationToken)
    {
